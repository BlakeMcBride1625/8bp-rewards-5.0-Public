...
const ResetLeaderboardAuthModal: React.FC<ResetLeaderboardAuthModalProps> = ({
  ...
  const requestEmailCode = async () => {
    try {
      setIsLoading(true);
      const response = await axios.post(API_ENDPOINTS.ADMIN_RESET_LEADERBOARD_REQUEST_ACCESS, { channel: 'email' }, {
        withCredentials: true
      });
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-text-secondary dark:text-text-dark-secondary">
                    ...
                    You'll need the provided code to reset the leaderboard.
                  </p>
                </div>
